...
<section role="main" class="content-body">
    @component('components.admin.header-main', ['title' => __('header_title.permission_management')])
        @slot('ol')
            <li><span>{{ __('header_title.platform_administration') }}</span></li>
            <li><span>{{ __('header_title.permission_management') }}</span></li>
        @endslot
    @endcomponent
                ...
                <header class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-sm-6 pull-right text-right">
                            {{-- <a href="{{ route('adusers.create') }}" id="" class="btn btn-info"><i class="fa fa-plus"></i> Create </a> --}}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions-hover actions-fade">
                                        <a href="{{ route('adpermissions.edit', $id) }}"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
